...
testProcessProject(
  'guards should only be generated for types that are both exported and annotated in the current file',
  {
    'custom.ts': `
...
testProcessProject(
  'in exportAll mode, guards should only be generated for types that are exported in the current file',
  {
    'custom.ts': `
    export type Color = 'red' | 'blue' | 'green'`,
    'index.ts': `
  ...
  { /* only: true, */ options: { exportAll: true } }
)
